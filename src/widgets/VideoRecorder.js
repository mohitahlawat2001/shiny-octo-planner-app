...
const VideoRecorder = () => {
  ...
  return (
    <div id="video-recorder-widget">
      ...
      <video ref={videoRef} autoPlay playsInline muted style={{ display: isRecording ? 'block' : 'none' }}></video>
      ...
      {videoBlob && (
        <div id="preview-section">
          <h3>Preview</h3>
          <video id="preview-video" controls src={URL.createObjectURL(videoBlob)}></video>
          <br />
